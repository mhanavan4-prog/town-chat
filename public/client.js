...
// ---------------------------------------------------------------------------
function createAudio({ getMe, setUnlockToast }) {
let audioCtx = null;
let musicGain = null;
...
// ---------------------------------------------------------------------------
function createCollision({ getWorld, getWalls, getDungeonLore, getDelveState }) {
...
function createShop({ send, getBankState, getInventoryState, ITEM_CATALOG, showItemTooltip, hideTooltip, openQuestDialogue }) {
...
function createSpellbook({ send, cancelTargeting, setDefaultFloatPos, SPELL_CATALOG, armTargeting, buildEmojiCursor, SWORD_CURSOR, actionOnCooldown, startActionCooldown, visuals }) {
...
function createBoard({ send, getBoardState, getMe, shortWhen }) {
...
function createDelve({ getWs, getDelveState, getWeeklyDelveMods }) {
...
function createNotif({ getPushPublicKey, getPushAvailable, accountAuth, apiUrlMaybe, setUnlockToast }) {
...
function createLegendShop({ getWs, getMyMoonstones, setMyMoonstones, refreshMsUI, openMsModal, ITEM_CATALOG }) {
...
function createConsent({ getWs, captureSelfiePhoto }) {
...
// ---------------------------------------------------------------------------
function createVaultScene({ makeStoneTexture, makeSignSprite, buildInteriorDoorway, VAULT_WORLD, setVaultScene, setVaultCamera }) {
...
// ---------------------------------------------------------------------------
function createCaveScene({ makeSignSprite, makeNpcNameSprite, createHumanoid, CAVE_WORLD, setCaveScene, setCaveCamera }) {
...
// ---------------------------------------------------------------------------
function createDungeonScene({ buildPortalMesh, DUNGEON_LAYOUTS, DUNGEON_CAVE_THEMES, getDungeonScene, setDungeonScene, setDungeonCamera, getDungeonKiosks, setDungeonKiosks, setDungeonMobVisuals, getBuiltDungeonTier, setBuiltDungeonTier }) {
...
// ---------------------------------------------------------------------------
function createTownProps({ makeGlowTexture, makeBarrel, KK, LAMP_GLOWS }) {
...
// ---------------------------------------------------------------------------
function createCreatures({ lerpAngle, makeHealthBarSprite, updateHealthBar, getOutdoorScene, getWildsScene, getAnimalVisuals, setAnimalVisuals, getAnimalVisuals2, setAnimalVisuals2 }) {
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
function createWildsScene({ GFX, WILDS_CAMPFIRES, WILDS_KIOSKS, WILDS_NPCS, WILDS_WALLS, WILDS_WAYMARKERS, WITCH_CAVE_ENTRANCE_X, WITCH_CAVE_ENTRANCE_Z, addMobs2, addMobs3, addNatureDecor, addSpookyDecor, buildPortalMesh, createHumanoid, kkWildsDressing, makeSpookyTree, makeWaymarkerStone, makeWildsCampfire, wildsCollide, makeGrassTexture, makeGlowTexture, makeSignSprite, makeNpcNameSprite, getDecorVisuals2, getAddAnimals2, setWildsScene, setWildsCamera, setLextonNpc }) {
